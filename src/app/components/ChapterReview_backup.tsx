...
const ChapterReview = React.memo(function ChapterReview({ chapterNumber, onBack }: ChapterReviewProps) {
  ...
  const getQuestionsForChapter = (chapter: number) => {
    const sampleQuestions = {
      ...
      ,
      59: [
        { question: "If the age structure of a country's population is balanced, what prediction can be made about the near future?", options: ["The population will increase rapidly.", "The population will not increase rapidly.", "The population will decrease rapidly.", "The population will oscillate."], correct: 1 },
        ...
        { question: "World human population in 2017 was approximately:", options: ["5 billion.", "10 billion.", "3.5 billion.", "7.5 billion."], correct: 3 },
        { question: "What percentage of the population are under the age of 15 in West Africa?", options: ["~50", "~25", "~10", "~5"], correct: 0 },
        { question: "What naturally occurring process is responsible for keeping the earth warm enough to sustain life?", options: ["Greenhouse effect", "Ozone depletion", "Solar flares", "Plate tectonics"], correct: 0 },
        { question: "The Earth's surface releases_________ that is absorbed by the atmosphere, stabilizing or raising atmospheric temperature.", options: ["shortwave visible radiation", "ultraviolet radiation", "long-wave infrared radiation", "microwave radiation"], correct: 2 },
        { question: "What will be a consequence if current predictions of global warming are accurate?", options: ["Global biodiversity will automatically increase.", "No species will be affected.", "Weather patterns will remain unchanged.", "Organisms will need to migrate or adapt quickly in order to survive."], correct: 3 },
        { question: "Which organism would be most likely to be able to survive rapid global climate change?", options: ["an insect that can feed upon many different plant species", "a specialist insect feeding on a single plant species", "a large slow-reproducing mammal", "a plant with a very narrow temperature tolerance"], correct: 0 },
        { question: "Replacing forests with agricultural or urban areas can significantly affect the water cycle. Why is this?", options: ["More moisture is evapotranspired after deforestation.", "Less moisture is evapotranspired into the atmosphere after deforestation.", "The total precipitation always increases after deforestation.", "Deforestation has no effect on the water cycle."], correct: 1 },
        { question: "The movement of chemicals through ecosystems is known as:", options: ["trophic transfer.", "primary production.", "biogeochemical cycling.", "ecological succession."], correct: 2 },
        { question: "How does DDT in the environment affect many birds?", options: ["increased reproductive rate", "no effect", "improved survival", "decreased reproductive rate"], correct: 3 },
        { question: "Biogeochemical cycles involve:", options: ["the movement of chemicals through ecosystems.", "only energy flow", "only decomposition", "only primary production"], correct: 0 },
        { question: "The process by which elevated nutrient levels lead to an overgrowth of algae and the subsequent depletion of water oxygen levels is known as:", options: ["acidification.", "eutrophication.", "biomagnification.", "denitrification."], correct: 1 },
        { question: "Where are the largest reserves of carbon on the planet?", options: ["the atmosphere", "living biomass", "rocks and fossil fuels", "surface ocean water"], correct: 2 },
        { question: "Each year, plants and algae remove approximately_________ of the [CO2] in the atmosphere.", options: ["1/2", "1/100th", "all of it", "1/7th"], correct: 3 },
        { question: "What percentage of the earth's atmosphere consists of nitrogen gas?", options: ["78%", "21%", "0.04%", "50%"], correct: 0 },
        { question: "Ammonification is the conversion of_________ to [ammonia] and [ammonium].", options: ["organic nitrogen", "nitrate", "nitrogen gas", "ammonia"], correct: 0 },
        { question: "The process by which soil bacteria convert [ammonia] or [ammonium] to nitrate is called:", options: ["nitrification.", "denitrification.", "ammonification.", "nitrogen fixation."], correct: 0 },
        { question: "Deforestation in areas like Madagascar can significantly affect the water cycle. Why is this?", options: ["Less moisture is transpired into the atmosphere after deforestation.", "More moisture is transpired after deforestation.", "Deforestation increases annual rainfall.", "Deforestation does not affect transpiration."], correct: 0 },
        { question: "Lead is known to undergo biomagnification and accumulate in bones. What do you predict will happen to lead taken up by a tiger after it dies in the wild?", options: ["The lead will reenter the food web via detritivores and decomposers.", "The lead will be destroyed and disappear.", "The lead will spontaneously vaporize.", "The lead will be excreted by scavengers without consequence."], correct: 0 },
        { question: "What do you think would result if nitrogen-fixing cyanobacteria populations suddenly declined?", options: ["Aquatic primary production would decline, particularly in regions not subject to fertilizer runoff.", "Aquatic primary production would increase.", "There would be no effect on primary production.", "Fish biomass would immediately double."], correct: 0 },
        { question: "What substance would you expect to accumulate in soil as a result of increased acid precipitation?", options: ["Ammonia", "Calcium carbonate", "Glucose", "Oxygen"], correct: 0 },
        { question: "Lakes with elevated dissolved nutrients and low water clarity are called:", options: ["eutrophic.", "oligotrophic.", "mesotrophic.", "dystrophic."], correct: 0 },
        { question: "Which organism would be least likely to be able to survive rapid global climate change?", options: ["An insect species that lays its eggs and feeds upon a single plant species with a short flowering period", "A generalist insect that feeds on many plants", "A rapidly reproducing microbe", "A migratory bird with flexible diet"], correct: 0 },
        { question: "Sea levels are rising as the Earth's temperature increases, mainly because:", options: ["glaciers are melting.", "the Earth's volume is expanding.", "more water is created chemically.", "the ocean is evaporating."], correct: 0 },
        { question: "Which cause of habitat destruction is the fastest-growing and most destructive use of land?", options: ["Urbanization", "Small-scale subsistence farming", "Volcanic activity", "Natural succession"], correct: 0 },
        { question: "One type of habitat loss is particularly destructive. This habitat is known for being especially species-rich, full of oxygen-generating trees, plus many plants that might provide genetic variability for crop plants or secondary metabolites with pharmaceutical properties. Which habitat?", options: ["Tropical rainforest", "Temperate grassland", "Desert", "Boreal forest"], correct: 0 },
        { question: "What percent of the world's land is used for crops and livestock pastures?", options: ["37%", "10%", "5%", "60%"], correct: 0 },
        { question: "In India, the cattle disease rinderpest caused only mild illness, but in Africa the same disease killed over 80% of the cattle across the continent. What is the best explanation for the difference?", options: ["Genetic resistance in the Indian cattle due to prior exposure", "Climate differences", "Different species of cattle in India", "Rinderpest is a different virus in Africa"], correct: 0 },
        { question: "In the summer of 2016, people sweltering in the midwestern United States didn't say, \"It's not the heat, it's the humidity.\" Instead, they said \"It's the cornsweat.\" Many blamed surrounding acres of cornfields for increasing the perceived temperature, already at record levels. Considering what you know about the water cycle, what information might address this idea?", options: ["Since 90% of the water in the atmosphere over land arrived there by evapotranspiration, it is reasonable to conclude that increased acreage of corn cultivation could increase local humidity.", "Cornfields reduce evapotranspiration and decrease humidity.", "Evapotranspiration is irrelevant to local humidity.", "Irrigation always decreases atmospheric moisture."], correct: 0 },
        { question: "Hawaiian honeycreepers, which are closely related to North American finches, have been devastated by the introduction of mosquitoes and now survive only at sufficiently high elevations which are devoid of mosquitoes. Given what you know about the potential problems 1with introduced species,2 why have mosquitoes been so detrimental to Hawaiian honeycreepers when birds all over the world have been exposed to mosquitoes with little or no negative consequences?", options: ["Mosquitoes are not native to Hawaii and hence Hawaiian honeycreepers have evolved no defenses against the diseases that mosquitoes transmit.", "Hawaiian birds are naturally sterile.", "Mosquitoes in Hawaii are larger and more voracious.", "Honeycreepers prefer high elevations for other reasons."], correct: 0 },
        { question: "Introduced species become invasive when they:", options: ["expand their range and outcompete native species.", "are removed by predators.", "fail to reproduce.", "immediately go extinct."], correct: 0 },
        { question: "The amount of land needed to produce all the resources someone uses and to absorb all the image they release through their choices is called their:", options: ["ecological footprint.", "carbon tax.", "sustainability index.", "biocapacity."], correct: 0 },
        ...
        { question: "The Intergovernmental Panel on Climate Change reported in 2007 that atmospheric carbon dioxide levels will nearly double by the end of this century. If this happens, what will be the atmospheric concentration of carbon dioxide?", options: ["700 ppm", "350 ppm", "1000 ppm", "200 ppm"], correct: 0 }
      ]
    };
