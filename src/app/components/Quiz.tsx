...
const sampleQuestions = {
  ...
  59: [
    { id: 1, question: "If the age structure of a country's population is balanced, what prediction can be made about the near future?", options: ["The population will increase rapidly.", "The population will not increase rapidly.", "The population will decrease rapidly.", "The population will oscillate."], correct: 1 },
    { id: 2, question: "You are studying with a classmate who asks you about the concept of a replacement rate. She wants to know what happens to a population if the replacement rate is reached? She also assumes the average human replacement rate is 2.0. What would you tell her?", options: ["The population will grow exponentially once replacement rate is reached.", "Replacement rate being 2.0 means population will double every generation.", "When replacement rate is reached, the population is in equilibrium. The replacement rate is greater than 2.0 because some individuals die before they reproduce.", "Replacement rate has no effect on population size."], correct: 2 },
    { id: 3, question: "World human population in 2017 was approximately:", options: ["5 billion.", "10 billion.", "3.5 billion.", "7.5 billion."], correct: 3 },
    { id: 4, question: "What percentage of the population are under the age of 15 in West Africa?", options: ["~50", "~25", "~10", "~5"], correct: 0 },
    { id: 5, question: "What naturally occurring process is responsible for keeping the earth warm enough to sustain life?", options: ["Ozone depletion", "Greenhouse effect", "Solar flares", "Plate tectonics"], correct: 1 },
    { id: 6, question: "The Earth's surface releases_________ that is absorbed by the atmosphere, stabilizing or raising atmospheric temperature.", options: ["shortwave visible radiation", "ultraviolet radiation", "long-wave infrared radiation", "microwave radiation"], correct: 2 },
    { id: 7, question: "What will be a consequence if current predictions of global warming are accurate?", options: ["Global biodiversity will automatically increase.", "No species will be affected.", "Weather patterns will remain unchanged.", "Organisms will need to migrate or adapt quickly in order to survive."], correct: 3 },
    { id: 8, question: "Which organism would be most likely to be able to survive rapid global climate change?", options: ["an insect that can feed upon many different plant species", "a specialist insect feeding on a single plant species", "a large slow-reproducing mammal", "a plant with a very narrow temperature tolerance"], correct: 0 },
    { id: 9, question: "Replacing forests with agricultural or urban areas can significantly affect the water cycle. Why is this?", options: ["More moisture is evapotranspired after deforestation.", "Less moisture is evapotranspired into the atmosphere after deforestation.", "The total precipitation always increases after deforestation.", "Deforestation has no effect on the water cycle."], correct: 1 },
    { id: 10, question: "The movement of chemicals through ecosystems is known as:", options: ["trophic transfer.", "primary production.", "biogeochemical cycling.", "ecological succession."], correct: 2 },
    { id: 11, question: "How does DDT in the environment affect many birds?", options: ["increased reproductive rate", "no effect", "improved survival", "decreased reproductive rate"], correct: 3 },
    { id: 12, question: "Biogeochemical cycles involve:", options: ["the movement of chemicals through ecosystems.", "only energy flow", "only decomposition", "only primary production"], correct: 0 },
    { id: 13, question: "The process by which elevated nutrient levels lead to an overgrowth of algae and the subsequent depletion of water oxygen levels is known as:", options: ["acidification.", "eutrophication.", "biomagnification.", "denitrification."], correct: 1 },
    { id: 14, question: "Where are the largest reserves of carbon on the planet?", options: ["the atmosphere", "living biomass", "rocks and fossil fuels", "surface ocean water"], correct: 2 },
    ...
    { id: 16, question: "What percentage of the earth's atmosphere consists of nitrogen gas?", options: ["78%", "21%", "0.04%", "50%"], correct: 0 },
    { id: 17, question: "Ammonification is the conversion of_________ to [ammonia] and [ammonium].", options: ["nitrate", "organic nitrogen", "nitrogen gas", "ammonia"], correct: 1 },
    { id: 18, question: "The process by which soil bacteria convert [ammonia] or [ammonium] to nitrate is called:", options: ["denitrification.", "ammonification.", "nitrification.", "nitrogen fixation."], correct: 2 },
    { id: 19, question: "Deforestation in areas like Madagascar can significantly affect the water cycle. Why is this?", options: ["More moisture is transpired after deforestation.", "Deforestation increases annual rainfall.", "Deforestation does not affect transpiration.", "Less moisture is transpired into the atmosphere after deforestation."], correct: 3 },
    { id: 20, question: "Lead is known to undergo biomagnification and accumulate in bones. What do you predict will happen to lead taken up by a tiger after it dies in the wild?", options: ["The lead will reenter the food web via detritivores and decomposers.", "The lead will be destroyed and disappear.", "The lead will spontaneously vaporize.", "The lead will be excreted by scavengers without consequence."], correct: 0 },
    { id: 21, question: "What do you think would result if nitrogen-fixing cyanobacteria populations suddenly declined?", options: ["Aquatic primary production would increase.", "Aquatic primary production would decline, particularly in regions not subject to fertilizer runoff.", "There would be no effect on primary production.", "Fish biomass would immediately double."], correct: 1 },
    { id: 22, question: "What substance would you expect to accumulate in soil as a result of increased acid precipitation?", options: ["Calcium carbonate", "Glucose", "Ammonia", "Oxygen"], correct: 2 },
    { id: 23, question: "Lakes with elevated dissolved nutrients and low water clarity are called:", options: ["oligotrophic.", "mesotrophic.", "dystrophic.", "eutrophic."], correct: 3 },
    { id: 24, question: "Which organism would be least likely to be able to survive rapid global climate change?", options: ["An insect species that lays its eggs and feeds upon a single plant species with a short flowering period", "A generalist insect that feeds on many plants", "A rapidly reproducing microbe", "A migratory bird with flexible diet"], correct: 0 },
    { id: 25, question: "Sea levels are rising as the Earth's temperature increases, mainly because:", options: ["the Earth's volume is expanding.", "glaciers are melting.", "more water is created chemically.", "the ocean is evaporating."], correct: 1 },
    { id: 26, question: "Which cause of habitat destruction is the fastest-growing and most destructive use of land?", options: ["Small-scale subsistence farming", "Volcanic activity", "Urbanization", "Natural succession"], correct: 2 },
    { id: 27, question: "One type of habitat loss is particularly destructive. This habitat is known for being especially species-rich, full of oxygen-generating trees, plus many plants that might provide genetic variability for crop plants or secondary metabolites with pharmaceutical properties. Which habitat?", options: ["Temperate grassland", "Desert", "Boreal forest", "Tropical rainforest"], correct: 3 },
    { id: 28, question: "What percent of the world's land is used for crops and livestock pastures?", options: ["37%", "10%", "5%", "60%"], correct: 0 },
    { id: 29, question: "In India, the cattle disease rinderpest caused only mild illness, but in Africa the same disease killed over 80% of the cattle across the continent. What is the best explanation for the difference?", options: ["Climate differences", "Genetic resistance in the Indian cattle due to prior exposure", "Different species of cattle in India", "Rinderpest is a different virus in Africa"], correct: 1 },
    { id: 30, question: "In the summer of 2016, people sweltering in the midwestern United States didn't say, \"It's not the heat, it's the humidity.\" Instead, they said \"It's the cornsweat.\" Many blamed surrounding acres of cornfields for increasing the perceived temperature, already at record levels. Considering what you know about the water cycle, what information might address this idea?", options: ["Cornfields reduce evapotranspiration and decrease humidity.", "Evapotranspiration is irrelevant to local humidity.", "Since 90% of the water in the atmosphere over land arrived there by evapotranspiration, it is reasonable to conclude that increased acreage of corn cultivation could increase local humidity.", "Irrigation always decreases atmospheric moisture."], correct: 2 },
    ...
    { id: 33, question: "The amount of land needed to produce all the resources someone uses and to absorb all the image they release through their choices is called their:", options: ["carbon tax.", "ecological footprint.", "sustainability index.", "biocapacity."], correct: 1 },
    { id: 34, question: "Which of these best describes how global warming works?:", options: ["The Sun is producing more total energy than before.", "The Earth is moving closer to the Sun.", "Heat that would normally be lost into space is instead trapped and bounced around in the atmosphere.", "Greenhouse gases cool the atmosphere."], correct: 2 },
    { id: 35, question: "The Intergovernmental Panel on Climate Change reported in 2007 that atmospheric carbon dioxide levels will nearly double by the end of this century. If this happens, what will be the atmospheric concentration of carbon dioxide?", options: ["350 ppm", "1000 ppm", "200 ppm", "700 ppm"], correct: 3 }
  ],
  60: [
    { id: 1, question: "Biological diversity is composed of what three levels?", options: ["genetic; species; and ecosystem diversity", "species; population; and community diversity", "individual; population; and ecosystem diversity", "genetic; population; and community diversity"], correct: 0 },
    { id: 2, question: "In the context of biodiversity, genetic diversity consists of:", options: ["the number of different species in an ecosystem", "the amount of genetic variation that occurs within and between populations", "the variety of different ecosystems in a region", "the total number of individuals in a population"], correct: 1 },
    { id: 3, question: "Endangered species:", options: ["are extinct in the wild but survive in captivity", "have stable populations throughout their range", "are in danger of extinction throughout all or most of their range", "are found only in protected areas"], correct: 2 },
    { id: 4, question: "Threatened species:", options: ["are already extinct", "are abundant in their natural habitat", "have recovered from near extinction", "are species likely to become endangered in the future"], correct: 3 },
    { id: 5, question: "Ecosystem diversity:", options: ["refers to the structure and function within an ecosystem", "measures only the number of species present", "focuses solely on genetic variation", "counts only endangered species"], correct: 0 },
    { id: 6, question: "According to the diversity-stability hypothesis:", options: ["species diversity has no effect on ecosystem stability", "A loss of any species from an ecosystem leads to an approximately equal decline in stability", "only keystone species affect ecosystem stability", "ecosystem stability increases exponentially with species number"], correct: 1 },
    { id: 7, question: "According to the redundancy hypothesis, species are redundant if:", options: ["they are endangered", "they are found in multiple ecosystems", "they could be eliminated or replaced by others with little loss of ecosystem function", "they have large population sizes"], correct: 2 },
    { id: 8, question: "The idiosyncratic hypothesis suggests that:", options: ["all species contribute equally to ecosystem function", "keystone species control all ecosystem functions", "species can be easily replaced without consequence", "Ecosystem function changes unpredictably as the number of species increases or decreases"], correct: 3 },
    { id: 9, question: "In a series of field experiments, David Tilman and colleagues investigated biodiversity and ecosystem function. They found a relationship between:", options: ["species richness and ecosystem function", "population size and genetic diversity", "habitat area and species number only", "climate and species distribution"], correct: 0 },
    { id: 10, question: "Megadiversity countries are those countries that:", options: ["have the most protected land area", "have the largest number of endemic plant species", "spend the most on conservation", "have the highest population density"], correct: 1 },
    { id: 11, question: "Geographic biodiversity \"hot spots\":", options: ["are regions with high temperatures", "are areas with recent volcanic activity", "have ≥1500 endemic plant species and have lost ≥70% of the original habitat", "contain the world's largest ecosystems"], correct: 2 },
    { id: 12, question: "An endemic species is one that:", options: ["is introduced to new habitats", "migrates seasonally", "lives in multiple continents", "is found in only one particular place or region"], correct: 3 },
    { id: 13, question: "The study of the spatial arrangement of elements in communities and ecosystems is known as:", options: ["landscape ecology", "population genetics", "community biology", "ecosystem dynamics"], correct: 0 },
    { id: 14, question: "What shape park is preferable for minimizing edge effects?", options: ["rectangular", "circular", "linear", "triangular"], correct: 1 },
    { id: 15, question: "The propagation of animals and plants outside their natural habitat is called:", options: ["habitat restoration", "ecosystem management", "captive breeding", "species reintroduction"], correct: 2 },
    { id: 16, question: "In an effort to protect and breed the California condor, a rescue program:", options: ["relocated the birds to different states", "provided supplemental feeding in the wild", "established protected nesting sites only", "captured the few remaining wild birds to breed them in captivity"], correct: 3 },
    { id: 17, question: "Which of these is the best example of an umbrella species?", options: ["northern spotted owl", "domestic cat", "house sparrow", "fruit fly"], correct: 0 },
    { id: 18, question: "The wild Tasmanian devil population has decreased 70% since 1996 due to a contagious form of cancer known as Devil Facial Tumor Disease. Researchers have found several individuals that show partial resistance to the cancer. Attempts to breed these individuals and preserve their DNA in the population would fall under what level of biological diversity?", options: ["Ecosystem diversity", "Genetic diversity", "Species diversity", "Community diversity"], correct: 1 },
    { id: 19, question: "As you walk between classes on your college campus, you notice squirrels busily burying acorns. You realize you are witnessing what ecosystem service?", options: ["Pollination", "Pest control", "Seed dispersal", "Water filtration"], correct: 2 },
    { id: 20, question: "You are conducting a long term study of ecosystem functioning in a freshwater lake. You and your field assistants gather data for many biotic and abiotic factors, including species diversity, water and benthic quality, and turbidity. Over the ten years of your study, you find that the abundance of water lilies is correlated with several other factors. When water toxicity and turbidity are high and water pH is abnormally low, water lilies quickly become scarce, followed by periods where fish, amphibians, and water birds are also scarce or absent. In years water nutrient levels are very high, water lilies quickly become abundant, followed by years where wading birds are scarce. From these data, you conclude that water lilies are:", options: ["a flagship species", "an umbrella species", "a keystone species", "an indicator species"], correct: 3 },
    { id: 21, question: "Grizzly bears have large geographic ranges that consist of mosaics of forests and grasslands at varying altitudes. Grizzlies also require relatively pristine water sources in their range. Based on this, what species type best describes grizzly bears?", options: ["umbrella species", "indicator species", "flagship species", "keystone species"], correct: 0 },
    { id: 22, question: "The Florida panther, as an appealing symbol of Florida's conservation campaign, serves as a(n):", options: ["keystone species", "flagship species", "indicator species", "umbrella species"], correct: 1 },
    { id: 23, question: "In the northeastern Pacific ocean, sea otters occur at a relatively low abundance. By preying upon sea urchins, sea otters maintain underwater kelp (large algae) \"forests\", which would otherwise be decimated by the herbivorous sea urchins. The kelp forests supply food for a wide variety of marine organisms, as well as providing refuge from predation and nursery habitat for juveniles. Based on this, what type of species best describes sea otters?", options: ["umbrella species", "flagship species", "keystone species", "indicator species"], correct: 2 },
    { id: 24, question: "A nonprofit conservation organization receives a sizeable donation and decides to purchase several thousand acres of \"high desert\" in southern California. This particular type of desert has an intermediate level of species diversity and few unique species. However, much of the original areas of high desert have been converted to suburban housing and shopping. The decision by the nonprofit to preserve this area was most likely based upon what conservation strategy?", options: ["Protection of keystone species", "Preservation of flagship species", "Conservation of endemic species", "Conservation of representative habitats"], correct: 3 },
    { id: 25, question: "On a field study in Costa Rica, you discover a new species of frog! After careful work to determine the size and range of the population, you conclude sadly that the species has very few individuals in an ever-shrinking limited range. The entire species could be wiped out at any time. When you write up your report on the frog, how should you describe its status?", options: ["Endangered", "Threatened", "Vulnerable", "Near threatened"], correct: 0 },
    { id: 26, question: "A lack of genetic diversity in a species usually results in:", options: ["increased population size", "less ability to adapt to change in the environment", "faster reproduction rates", "improved disease resistance"], correct: 1 },
    { id: 27, question: "Which of these is the best definition for what an ecosystem service is?", options: ["The study of ecosystem components", "Any benefit humans get from healthy, functioning ecosystems", "The protection of endangered species", "The management of natural resources"], correct: 2 },
    { id: 28, question: "In temperate forest ecosystems that have been logged or otherwise have relatively few species, the productivity (an ecosystem function) is much lower than in forest ecosystems that have more species. The maximum number of species in an ecosystem varies tremendously across similar habitats on different continents. Despite that variation, the maximum ecosystem function is similar. If the ecosystem function relates to species richness when there are few species, but not as much when there are many, this is evidence for which hypothesis?", options: ["Redundancy hypothesis", "Idiosyncratic hypothesis", "Keystone species hypothesis", "Diversity-Stability hypothesis"], correct: 3 },
    { id: 29, question: "Cloning is a type of:", options: ["captive breeding", "habitat restoration", "species reintroduction", "genetic modification"], correct: 0 },
    { id: 30, question: "Sustainable development is best defined as:", options: ["protecting all natural areas from human use", "allowing people to improve their lifestyle while still maintaining natural resources", "using only renewable energy sources", "eliminating all industrial activities"], correct: 1 }
  ],
};
